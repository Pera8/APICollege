    ...
    public partial class addUser : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CollegeProfessor", x => new { x.CollegesId, x.ProfessorsId });
                    table.ForeignKey(
                        name: "FK_CollegeProfessor_Colleges_CollegesId",
                        column: x => x.CollegesId,
                        principalTable: "Colleges",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CollegeProfessor_Professors_ProfessorsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CollegeProfessor_ProfessorsId",
                table: "CollegeProfessor",
                column: "ProfessorsId");
